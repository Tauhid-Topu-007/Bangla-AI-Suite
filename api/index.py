...
async def bangla_date_api():
    return JSONResponse(content=get_bangla_date())
...
<body>
    <div class="header">
        ...
        <div class="datetime-widget" id="datetime-widget">
            <span id="greeting">লোড হচ্ছে...</span>
    ...
    <div class="container">
        ...
        <div class="footer">
            <p><i class="fas fa-heart"></i> বাংলায় এআই - সম্পূর্ণ ফ্রি | Vercel Deployed</p>
        </div>
    </div>
    ...
    <script>
        ...
        // Update Bangla Date & Time
        async function updateBanglaDateTime() {
            try {
